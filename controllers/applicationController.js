...
export const postApplication = catchAsyncError(async(req,res,next)=>{
    ...
    if(!allowedFormats.includes(resume.mimetype)){
        return next(new ErrorHandler("Invalid file type. Please upload your resume png,jpg,webp format only",400));
    }
    ...
    const application = await Application.create({
        name,email,coverLetter,address,phone,applicantID,employerID,
        resume:{
